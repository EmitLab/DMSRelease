...
public class DataSimilarityOpentsdbEnergy  implements DataSimilarityInterface{
	DataSimilarityOpentsdbEnergy parent= null;
	...
	ArrayList<DataSimilarityOpentsdbEnergy> childs = new ArrayList<DataSimilarityOpentsdbEnergy>();
	int level=0;
	double max[];
	String name[];
	...
	int k=4;
	public DataSimilarityOpentsdbEnergy(DataSimilarityOpentsdbEnergy parent){
		this.parent= parent;
	}
	
	public DataSimilarityOpentsdbEnergy(DataSimilarityOpentsdbEnergy parent, int k,List<JSONObject> Resultset,MetricInterface metric, boolean isleaf){
	...
	public DataSimilarityOpentsdbEnergy(DataSimilarityOpentsdbEnergy parent, int k,List<JSONObject> Resultset,MetricInterface metric, String features, String currentMetric){
