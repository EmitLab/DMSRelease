...
public class DataSimilarityMongoEnergyMatlab implements DataSimilarityInterface{
	DataSimilarityMongoEnergyMatlab parent= null;
	...
	ArrayList<DataSimilarityMongoEnergyMatlab> childs = new ArrayList<DataSimilarityMongoEnergyMatlab>();
	int level=0;
	double max[];
	String name[];
	...
	int k=4;
	public DataSimilarityMongoEnergyMatlab(DataSimilarityMongoEnergyMatlab parent){
		this.parent= parent;
	}
	
	public DataSimilarityMongoEnergyMatlab(DataSimilarityMongoEnergyMatlab parent, int k,List<JSONObject> Resultset,MetricInterface metric, boolean isleaf){
	...
	public DataSimilarityMongoEnergyMatlab(DataSimilarityMongoEnergyMatlab parent, int k,List<JSONObject> Resultset,MetricInterface metric, String features, String currentMetric){
...
public static void SpectralKMeans (Cluster currentNode, int currentLevel) {
	...
	private String getData() {
		...
		for (int i = 0; i < this.data.size(); i++) {
			String Sim= this.data.get(i).getJSONObject("Meta").getString("SimID");
