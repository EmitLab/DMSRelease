...
public class MetricClusterMongo implements ClusteringInterface{
	...
	public MetricClusterMongo(int k, ArrayList<JSONObject> arrayList,boolean p) {
		this.k=k;
		...
		for(int i=0;i<arrayList.size();i++){
			try {
				...
				//	System.out.println("metric is different");
					if(matlab)
						lista.add(new DataSimilarityMongoMatlab(null, k, listofobject.get(listofobject.size()-1), null, features,metricList.get(metricList.size()-1)));
					else
						lista.add(new DataSimilarityMongo(null, k, listofobject.get(listofobject.size()-1), null, features,metricList.get(metricList.size()-1)));
	...
	public MetricClusterMongo(int k, ArrayList<JSONObject> arrayList) {
			...
			listofobject.get(correctmodelindex(arrayList.get(i))).add(arrayList.get(i));
			 ...
			 for(int i=0;i<metricList.size();i++){
				// System.out.println("listofobj : "+ listofobject.get(i).size());
				 ...
				 if(matlab)
					lista.add(new DataSimilarityMongoMatlab(null, k, listofobject.get(i), null, features,metricList.get(i)));
				 else
					lista.add(new DataSimilarityMongo(null, k, listofobject.get(i), null, features,metricList.get(i)));
...
/*public static void main(String[] args) {
	...
	MetricClusterMongo c= new MetricClusterMongo(4, array);
	c.print();
}
*/
@Override
