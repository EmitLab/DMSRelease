...
//import opentsdbcluster.XilunClusterEpidemic;
...
//import mongodb.cluster.metric.EuclidianDistance;

public class DataSimilarityMongoMatlab implements DataSimilarityInterface{
	DataSimilarityMongoMatlab parent= null;
	...
	ArrayList<DataSimilarityMongoMatlab> childs = new ArrayList<DataSimilarityMongoMatlab>();
	int level=0;
	double max[];
	String name[];
	...
	int k=4;
	public DataSimilarityMongoMatlab(DataSimilarityMongoMatlab parent){
		this.parent= parent;
	}
	
	public DataSimilarityMongoMatlab(DataSimilarityMongoMatlab parent, int k,List<JSONObject> Resultset,MetricInterface metric, boolean isleaf){
	...
	public DataSimilarityMongoMatlab(DataSimilarityMongoMatlab parent, int k,List<JSONObject> Resultset,MetricInterface metric, String features, String currentMetric){
		
		    System.out.println("here");
			try {
				
				setIndex(""+ Resultset.get(0).getJSONObject("Meta").getInt("Index"));
