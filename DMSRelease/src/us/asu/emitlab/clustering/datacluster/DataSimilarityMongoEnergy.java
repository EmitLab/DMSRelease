...
public class DataSimilarityMongoEnergy implements DataSimilarityInterface{
	DataSimilarityMongoEnergy parent= null;
	...
	ArrayList<DataSimilarityMongoEnergy> childs = new ArrayList<DataSimilarityMongoEnergy>();
	int level=0;
	double max[];
	String name[];
	...
	int k=4;
	public DataSimilarityMongoEnergy(DataSimilarityMongoEnergy parent){
		this.parent= parent;
	}
	
	public DataSimilarityMongoEnergy(DataSimilarityMongoEnergy parent, int k,List<JSONObject> Resultset,MetricInterface metric, boolean isleaf){
	...
	public DataSimilarityMongoEnergy(DataSimilarityMongoEnergy parent, int k,List<JSONObject> Resultset,MetricInterface metric, String features, String currentMetric){
