...
<head>
	...
	<!-- Code Link : https://startbootstrap.com/template-overviews/sb-admin-2/ -->
    ...
    <!-- Morris Charts CSS -->
    <link href="/DMS/DashUser/vendor/morrisjs/morris.css" rel="stylesheet">
	...
	<script>
		window.onload = function() {
			var userId    = '<%= session.getAttribute(SessionVariableList.USER_ID)%>';
			var projectId = '<%= session.getAttribute(SessionVariableList.CURRENT_PROJECT_ID)%>';
			initUserDashTopMenu(userId, projectId);
			initUserDashLeftSideBarMenu();
			initUserDashFooter(projectId);
			$(".loader").fadeOut("slow");
		};
	</script>
</head>
...
<body id="body">
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">View Databases</span>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">View Simulations</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">View Queries</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
    ...
    <script src="/DMS/DashUser/vendor/raphael/raphael.min.js"></script>
    <script src="/DMS/DashUser/vendor/morrisjs/morris.min.js"></script>
    <script src="/DMS/DashUser/data/morris-data.js"></script>
